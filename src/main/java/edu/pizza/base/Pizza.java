...
public class Pizza {
    ...
    public Pizza(String name, Topping... toppings) {
        this.name = name;
        // Agrega la masa como ingrediente por defecto
        agregarMasa();
    ...
    // Método para agregar la masa como ingrediente por defecto
    private void agregarMasa() {
        addTopping(new Topping("Masa", 12.0));
    }
}